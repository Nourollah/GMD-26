...
class DynamicsFactory:
    ...
    def create(cls, key: str, *args: typing.Any, **kwargs: typing.Any):
        ...
        if not builder:
            ...
            raise ValueError(
                f"Dynamic builder '{key}' is not registered. Available dynamics: {available_keys}")
...
class LangevinFlashMDBuilder(DynamicsBuilder):
    def build(
        ...
        **kwargs
        ...
        # model = MetatomicCalculator("Latest", device="cuda" if torch.cuda.is_available() else "cpu")
